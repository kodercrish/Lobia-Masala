...
# --- 5B. GridSearchCV for Random Forest (on 85% Split) ---
print("\n--- 5B. GridSearchCV for Random Forest ---")
...
# Define GridSearchCV parameter grid for Random Forest
# WARNING: This grid is very small. RF is slow to tune.
# Increase n_estimators for better performance, but it will be slower.
param_grid = {
...
# Train grid search ON THE 85% TRAINING SPLIT
print("Running GridSearchCV on 85% training data...")
...
# --- Evaluate grid search model ON VALIDATION SET ---
print("Evaluating GridSearch model on 15% validation data...")
y_val_log_pred_gs = best_gs_model.predict(X_val)
...
if rmse_val_gs < rmse_val_rf_base:
    print("\n✅ GridSearch model performed better. Retraining on FULL training data for submission...")
...
submission_filename = 'TestModels/rf_gridsearch_submission.csv' # Changed filename
